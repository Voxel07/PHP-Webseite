...
echo' <link rel="stylesheet" href="../Styles/style_join_us.css">';
?>
  <script src="../Skripte/Join_us.js">
     document.getElementById("popUp").display = none;
  </script>
  
  <div class="beschreibung">
        <p>Willkommen auf der Seite der Wild Rovers. Das ist das Regestrierformular. 
        </p>
        
        <p>Um zugang zur Seite zu bekommen bitte ausfüllen. 
        </p>

        <p>Wenn du nur mit uns in Kontackt treten möchtest gibt es ein paar möglichkeiten:</p>
        <br>
        <ul>
            <li>Schreib uns ne Email an: Wildrovers2016@googlemail.de</li>
            <li>Schreib uns auf den Sozialen Medien. Links dazu findest du am ende der Seite</li>
            <li></li>
        </ul>
    </div>
    ...
    <!-- Gibt fehlermeldungen an den User zurück -->
...
<div class="joinus_box">
    <div class="login-div">
        ...
        <div class="titel">
            <?php 
                if(isset($_GET['error'])){
                    echo'<div class="fehlermeldung">';
                    echo'<ul>';
                    if($_GET['error'] =="leerfelder"){
                        echo' <p>Bitte alle Felder ausfüllen </p> ';
                    }
                    else if($_GET['error'] =="ungültige_mail_nick"){
                        echo' <li> Ungültige Email und oder Nick </li> ';
                    }
                    else if($_GET['error'] =="ungültige_mail"){
                        echo' <li> Ungültige Email </li> ';
                    }
                    else if($_GET['error'] =="ungültiger_nick"){
                        echo' <li> Ungültiger Nick </li> ';
                    }
                    else if($_GET['error'] =="passwörter_unterschiedlich"){
                        echo' <li> Passwörter stimmen nicht überein </li> ';
                    }
                    else if($_GET['error'] =="doppelt"){
                        echo' <li> Nick oder Email bereits regestriert </li> ';
                    }
                    else if($_GET['error'] == "sql_error"){
                        echo' <li>Probier es nochmal oder schreib ne Mail !</li> ';
                    }
                    echo'</div>';
                    echo'</ul>';
                }
        ...
        <div class="felder">
            <form class ="reg" action="includes/signeup.inc.php" method="POST" enctype ="multipart/form-data">
            <!-- 
                Form leeren Funktion
                Geschlecht auswahl
            -->
        
        <!-- If füllt felder aus wenn ein Fehler gemacht wurde -->
            <?php
            //Vorname
            if(isset($_GET['vName'])){
                $vName = $_GET['vName'];
                echo' <div class="felder">
                <div class="input-box">
                        <div class="input-svg"> 
                        ...
                        <div class="input-text">
                            <input  id="Vorname" onfocus="JoinInpuTest(this)" onblur="fu(this)" type="text" name="vName"  placeholder="Vorname" maxlength ="25" value = "'.$vName.'" autofocus required />
            ...
            if(isset($_GET['nName'])){
                ...
                <div class="input-box">
                        ...
                        <div class="input-text">
                            <input  id="Nachname" onfocus="JoinInpuTest(this)" onblur="fu(this)" type="text" name="nName"  placeholder="Nachname" maxlength ="25" value = "'.$nName.'" required />
            ...
            if(isset($_GET['nick'])){
                ...
                <div class="input-box">
                        ...
                        <div class="input-text">
                            <input id="Nick" type="text" onfocus="JoinInpuTest(this)" onblur="fu(this)" name="nick" placeholder ="Nick" value = "'.$nick.'" maxlength="15" requierd>
            ...
            if(isset($_GET['mail'])){
                ...
                <div class="input-box">
                        ...
                        <div class="input-text">
                            <input  id="Email" type="email" onfocus="JoinInpuTest(this)" onblur="fu(this)" name="mail" placeholder="E-Mail" value = "'.$email.'" required/>
                ...
                <div class="input-box">
                        ...
                        <div class="input-text">
                            <input  id="Email" type="email" onfocus="JoinInpuTest(this)" onblur="fu(this)" name="mail" placeholder="E-Mail" required/>
                            <label id=label-Email>E-Mail</label>
                        </div>
                        <div id=input-Email class="input-check"></div>
                </div>
            ...
            if(isset($_GET['geb'])){
                ...
                <div class="input-box">
                        ...
                        <div class="input-text">
                            <input  type="date"  id="Geburtstag" onfocus="JoinInpuTest(this)" onblur="fu(this)"  name="geb"  placeholder="Geburtstag" vaule = '.$geb.'" required min="1900-01-01" max="3000-12-31"/>
            ...
            ?>
        <!--Passwörter werden nicht automatisch wieder befüllt-->
           <!-- Passwort -->
           <div class="felder">
                    <div class="input-box">
                            <div class="input-svg">
                            ...
                            <div class="input-text">
                                <input type="password" id="Passwort" onfocus="JoinInpuTest(this)" onblur="fu(this)" name="passwort" placeholder="Passwort" required/>
            ...
            <div class="felder">
                <div class="input-box">
                    ...
                    <div class="input-text">
                        <input type="password" id="Passwort-WDH" onfocus="JoinInpuTest(this)" onblur="fu(this)" name="passwort-wdh"  placeholder="Passwort wiederholen" required/>
            ...
            <button class="signin-button" type="submit" name ="signeup-submit">LOG IN</button>
        </form>       
        </div>
