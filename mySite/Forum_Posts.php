    ...
    echo'<div class = "Forum_Box">';
        ...
        <div class = "Post_Box">
            ...
            <div class ="Post_Ersteller" >';
                echo'<div class="Autor_Profielbild" style ="background-image: url(../Bilder/Mitglieder/Logo.png)">
                                    
                     </div>';
                echo'<div class="Autor_Name">
                        <p>'.$nutzer["Nick"].'</p>
                     </div>';
                echo'<div class="Autor_Posts">
                        <p>Anz.Beiträge:'.$nutzer["anz_Beiträge"].' </p>
                     </div>';
                echo'<div class="Autor_Posts">
                    <p>Anz.Antworten'.$nutzer["anz_Antworten"].' </p>
                    </div>';
                echo'
            </div>
            ...
            echo'<div class ="Antwort_Box">'; 
                ...
                //Bild einfügen
                    ...
                    echo'<div class="Autor_Name">
                        ...
                        echo'<div class="Autor_Posts">
                            <p>Beiträge: '.$antworter["anz_Beiträge"].' </p>
                            </div>';
                        echo'<div class="Autor_Posts">
                        <p>Antworten: '.$antworter["anz_Antworten"].' </p>
                        </div>';
                echo'</div>';
                echo'<div class="Antwort_Text">
                        <p>'.$row['inhalt'].'</p>
                    </div> ';
        ...
        echo'<div class="">';
            echo'<form action = "includes/Forum_Antworten.inc.php?herkunft=Forum_Posts.php&zugThema='.$post["zugThema"].'" method="post">             
                    ...
                    <input type ="text" name ="post" placeholder="pfusch" value='.$postZumAufrufen.' readonly></input>
