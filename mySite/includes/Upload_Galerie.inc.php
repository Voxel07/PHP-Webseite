...
// $test2 = $_POST['titel'];
// echo 'hallo';
// header("Location: ../Galerie.php?test:".$test );
...
if(isset($_POST['upload-Galerie-einzel'])&&isset($_SESSION['User']))
{
    ...
    if(in_array( $fileActualExt,$allowed)){
        if($dateiError === 0){
            ...
            if($dateiSize < 2000000000){
                $dateinameServer = "galerie_" . uniqid("",true) . "." . $fileActualExt; //Dateiname unterdem Sie gespeichert wird
                $pfad = "../../Uploads/Bilder_Galerie/Vollbild_Bilder/". $dateinameServer; //Wo soll die Datei gespeichert werdem
                    ...
                    if(!mysqli_stmt_prepare($stmt,$sql)){
                        ...
                        $sql2 = "INSERT INTO gallerie (Pfad, Reihenfolge, uploadDatum, Ersteller, Album) VALUES (?, ?, ?, ?, ?);";
                        ...
                        if(!mysqli_stmt_prepare($stmt,$sql2)){
                            ...
                            if(!mysqli_stmt_bind_param($stmt,"siiss",$dateinameServer,$reihenfolge,$Datum,$Nutzer,$Album)){
...
else if(isset($_POST['upload-Galerie-album'])&&isset($_SESSION['User']))
{
